 ...
 * 策略描述:
 */
@Strategy(name = "交易所套利异步报单", version = "1.0", outputMode = OutputMode.TIMER, outputPeriod = 3000, contractNumber = 1)
public class ExchangeArbitrageAsyOrder extends BaseStrategy {
	...
	public Object getShort(String arg) {
		System.out.println("获取空头持仓："+getDirPositionVol(getContractCode(), -1));
		return "获取多仓";
	}
	...
	@Event(name = "持仓均价", sequence = 10, argDisplay = false, arg = "")
	...
	@Event(name = "持仓均价2", sequence = 11, argDisplay = false, arg = "")
	...
	public void postStartStrategy() {
		x = 0;
		//order = this.orderInsert(price, vol, direct, OpenCloseFlag);
	}
